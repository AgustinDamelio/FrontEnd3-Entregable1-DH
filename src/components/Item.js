...
export default function Item(props) {
  ...
  return (
    <div className='producto'>
            ...
            <h5>Cantida en Stock:  {cantidadStock > 0 ? cantidadStock : <span>agotado</span> } </h5>
            <button onClick={comprar} disabled={cantidadStock < 1}> {cantidadStock > 0 ? 'COMPRAR': 'SIN STOCK'} </button>
    </div>
  )
}
